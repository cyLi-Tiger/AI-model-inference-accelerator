...
if __name__=='__main__':
    ...
    if args.dataset == 'cifar10':
        ...
        train_data = datasets.CIFAR10(root='D:/dataset/CIFAR10/', train=True, download=False, transform=transform_train)
        test_data = datasets.CIFAR10 (root='D:/dataset/CIFAR10/', train=False, download=False, transform=transform_test)
    ...
    if args.arch == 'VGG':
        ...
        model = models.VGG(num_classes, cfg=cfg, depth=19)
    ...
    torch.save(model.state_dict(), "D:/code/neuron-merging-main/saved_models/vgg_merged0.7.pth.tar")
    if args.evaluate:
        import time     
        T1 = time.time()    
